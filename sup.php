...
<body id="page-top">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                ...
                <div class="container-fluid">
                    <br>
                   <center> <h3 class="text-dark mb-1">Supprimer Utilisateur</h3></center>
                    <br><br>
                    <div class="card shadow">
                    <div class="card-header py-3">
                    <form  action="includes/sup.php"  method="POST">
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="input4">Nom</label>
      <input type="Text" class="form-control" id="input4" name="Nom" placeholder="Saleh" required>
    </div>
    <div class="form-group col-md-6">
      <label for="input5">Prenom</label>
      <input type="text" class="form-control" id="input5"  name="Prenom" placeholder="Ali"required>
    </div>
  </div>
 
  <div class="form-row">
    <div class="form-group col-md-6">
    <label for="input5">Votre Pass</label>
      <input type="password" class="form-control" id="input5"  name="Pass" placeholder="XlySD5"required>
  ...
  <button type="submit" class="btn btn-primary" name="submit">Supprimer</button> <a href="Services.php">     <button type="button" class="btn btn-primary" >Retour</button></a>
</form>
</div></div>         
                </div>
...
<?php
                                    ...
                                    if (isset($_GET['success'])){
                                      ...
                                      if ($_GET['success']== "Utilisateur_Supprimer" ){
