        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                ...
                <div class="container-fluid">
                    <br>
                   <center> <h3 class="text-dark mb-1">Affectation</h3></center>
                    <br><br>
...
<div class="card shadow">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
    <label for="inputState">Nature</label>
      <select id="input5" class="form-control"  name="nat">
        <option selected>Provisoire</option>
    ...
    <div class="form-group col-md-4">
      ...
      <input type="Date" class="form-control" id="input6" value="<?php
...
?>"    name="date">
  ...
  <button type="submit" class="btn btn-primary" name="submit">Affecter</button>
</form>
...
<?php
                                    if (isset($_GET['error'])){
                                     ...
                                     if ($_GET['error']== "out of stock"|| $_GET['error']=="Equipement deja Affecte" || $_GET['error']=="NSerie_Incorr"|| $_GET['error']=="Matricule_Incorr" ){
