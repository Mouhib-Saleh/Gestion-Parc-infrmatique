    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">Historique</h3>
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">historique des affectations</p>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                               <div class="text-md-right dataTables_filter" id="dataTable_filter"><label> <form action="table.php"  method="POST" >
                               <div class="row">
                               <div class="col-md-6">
                               <input type="search" class="form-control form-control-sm" aria-controls="dataTable" name ="mat" placeholder="Search">
                               </div>
                               <div class="col-md-0">
                               <button  class="btn btn-outline-info btn-sm" type="submit" name="submit">search</button>
...
{
    $to = $_POST['mat'];
    $selectSQL = "SELECT affectation.ID, perso.Nom, perso.Prenom, perso.Departement,perso.Matricule,affectation.Nature,affectation.dat
    FROM affectation
    INNER JOIN perso ON affectation.Matricule=perso.Matricule
    WHERE Affectation.Matricule='$to' ;";
...
?>
                        ...
                        <div class="row">
                            ...
                            <?php 
                             ...
                             {
                            echo" <a href='table.php'>     <button type='button' class='btn btn-primary' >Retour</button></a>";
                             }
                             else{
                            echo'<a href="Services.php">     <button type="button" class="btn btn-primary" >Retour</button></a>';
                             }
                              ?>
                            </div>
                            <div class="col-md-6">
