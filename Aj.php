...
<body id="page-top">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                ...
                <div class="container-fluid">
                    <br>
                   <center> <h3 class="text-dark mb-1">Ajouter Utilisateur</h3></center>
                    <br><br>
                    <div class="card shadow">
                    <div class="card-header py-3">
                    <form  action="includes/util.php"  method="POST">
  <div class="form-row">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
    <label for="input5">Pass</label>
      <input type="text" class="form-control" id="input5"  name="Pass" placeholder="XlySD5"required>
  ...
  <div class="form-row">
    ...
    <label for="inputState">Role</label>
      <select id="input5" class="form-control"  name="Nat">
  ...
  <button type="submit" class="btn btn-primary" name="submit">Ajouter</button> <a href="Services.php">     <button type="button" class="btn btn-primary" >Retour</button></a>
</form>
</div></div>         
                </div>
